...
from CHAPSim_post.legacy.utils import indexing, misc_utils
...
class CHAPSim_joint_PDF_base(Common,ABC):
    ...
    def plot_joint_PDF(self, xy_list,contour_kw=None,filled=False,fig=None, ax=None,**kwargs):
        ...
        if filled:
            contour_kw = cplt.update_pcolor_kw(contour_kw)
        else:
        ...
        for xy in xy_list:
            ...
            if filled:
                ax[i] = ax[i].contourf(U_mesh,V_mesh,pdf_array,**contour_kw)
            else:
